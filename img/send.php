...
$subject='Письмо с сайта Ostromedia.fi' .$callme;
...
$to = "veronika.pennanen@ostromedia.fi"; $to2="info@jupiterstudio.ru";

$message = "".$info2."".$callme."".$info."\n<br>Имя: ".$name."\n<br>Телефон: ".$phone."\n<br>Сообщение: ".$message;
$headers = 'From: info@ostromedia.fi' . "\r\n" . 'Reply-To: ' . $formEmail .  "\r\n" .'X-Mailer: Adobe Muse 7.3.5 with PHP/' . phpversion() . "\r\n" . 'Content-type: text/html; charset=utf-8' . "\r\n";

	$sent = @mail($to, $subject, $message, $headers);
	$sent = @mail($to2, $subject, $message, $headers);
